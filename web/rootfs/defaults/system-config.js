...
{{ $CONFIG_RESOLUTION_WIDTH_MIN := .Env.CONFIG_RESOLUTION_WIDTH | default "320" -}}
...
config.focusUserJid = '{{.Env.JICOFO_AUTH_USER}}@{{.Env.XMPP_AUTH_DOMAIN}}';
{{ else -}}
...
config.hosts.authdomain = '{{ .Env.XMPP_DOMAIN }}';
{{ end -}}
